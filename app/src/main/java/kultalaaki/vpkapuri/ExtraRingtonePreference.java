/*
 * Created by Kultala Aki on 23.1.2018 9:06
 * Copyright (c) 2018. All rights reserved.
 *
 * Last modified 23.1.2018 9:06
 */
...
/**
 * Created by Kultalaaki on 23.1.2018.
 */
...
public class ExtraRingtonePreference extends DialogPreference {
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        sounds.putAll(getSounds(RingtoneManager.TYPE_ALL));
